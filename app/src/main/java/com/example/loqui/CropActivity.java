...
//        recyclerViewSelectionList.setLayoutManager(layoutManager);
...
//                    Toast.makeText(CropActivity.this, "Xin hãy chọn lại hình", Toast.LENGTH_SHORT).show();
                    MyToast.showShortToast(CropActivity.this, "Please select an image");
                } else {
                    Intent data = new Intent();
                    data.setData(Utils.getImageUri(getApplicationContext(), croppedImage));
